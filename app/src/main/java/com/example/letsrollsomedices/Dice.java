...
/*
Я не знаю как правильно комменты делать
Класс, который позволяет считывать строку с кубиками и выдавать результат
...
ВСЕГДА НУЖНО ПИСАТЬ ЗНАК, ДАЖЕ ЕСЛИ МОДИФИКТОР/БРОСОК ПОЛОЖИТЕЛЬНЫЙ
Пример:
